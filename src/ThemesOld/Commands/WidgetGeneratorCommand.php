<?php namespace Veemo\Core\Themes\Commands;
...
class WidgetGeneratorCommand extends Command {
     ...
     * @var string
     */
    protected $name = 'veemo:theme:widget';
     ...
     * @return \Veemo\Core\ThemesOldOldOld\Commands\WidgetGeneratorCommand
     */
    ...
    public function fire()
    {
        ...
        // Directories.
        $container = $this->config->get('veemo.themes.containerDir');
        ...
        $widgetNamespace = $this->config->get('veemo.themes.namespaces.widget');
    ...
    {
        $path = public_path($this->config->get('veemo.themes.themeDir'));
