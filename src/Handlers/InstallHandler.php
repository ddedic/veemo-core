<?php namespace Veemo\Core\Handlers;
...
class InstallHandler
{
    ...
    public function fire(Command $console, $options = array())
    {
        ...
        $this->console->info('Veemo will now run all migrations and seeders.');

        if (!empty($options) && in_array('outside', $options)) {
            /*
            $this->console->call('migrate');
            $this->console->call('veemo:module:migrate');
            $this->console->call('db:seed');
            $this->console->call('veemo:module:seed');
            ...
            */
            ...
            if ($this->console->confirm('Would you like to continue? [yes|no]'))
            {
                /*
                $this->console->call('migrate');
                $this->console->call('veemo:migrate:module');
                $this->console->call('db:seed');
                $this->console->call('veemo:seed:module');
